...
export default class MetadataApiClass extends BaseApiClass {
  ...
  getOUUsers = async (orgUnitId) =>
    pull(this.baseUrl, this.username, this.password, `/api/organisationUnits/${orgUnitId}.json`, { paging: false }, [
      "fields=users[id,name,username]",
    ]);
    
  getUsers = async (userIds) =>
    pull(this.baseUrl, this.username, this.password, `/api/users.json`, { paging: false }, [
      "fields=id,name,username,userGroups",
