...
const CascadeTable = (props) => {
    ...
    const handleEditRow = (e, row, rowIndex) => {
        ...
        callbackFunction &&
            callbackFunction(metadata, dataRows, rowIndex, 'edit');
                ...
                md.valueSet.forEach((item) => {
                    ...
                    if (md.existCompulsory) {
                        if (data.length == 0) {
                            if (
                                item.compulsory &&
                                !_.some(data, { [md.code]: item.value })
                            ) {
    ...
    useEffect(() => {
        ...
        console.log('Cascade table origin', originMetadata);
                    ...
                    >
                        <Modal.Body>
                            <Card>
                                <Card.Body>
                                    <Card.Title>
                                        {uiLocale.familyMemberDetails}
                                    </Card.Title>
                                    <Card.Subtitle className="mb-2 text-muted">
                                        {formStatus !==
                                            FORM_ACTION_TYPES.ADD_NEW &&
