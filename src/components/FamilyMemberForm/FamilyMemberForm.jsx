...
const FamilyMemberForm = ({
    ...
    useEffect(() => {
        ...
        // let cascadeData =
        //   !_.isEmpty(currentEvent) && currentEvent.dataValues.oC9jreyd9SD
        //     ? [...JSON.parse(currentEvent.dataValues.oC9jreyd9SD).dataVals]
        //     : [];
    ...
    const editRowCallback = (metadata, previousData, data, code, value) => {
        ...
        console.log({ metadata, previousData, data, code });
        ...
        // For Initial
        if (data['sex'] === 'M') {
            metadata['firstname'].prefix = 'Mr';
        } else if (data['sex'] === 'F') {
            metadata['firstname'].prefix = 'Mrs';
        }
    };
    ...
    const callbackFunction = (
        ...
        if (actionType === 'delete_member_selected') {
            ...
            console.log(
                'callbackFunction rowIndex delete',
                rowIndex,
                actionType
            );
            return;
