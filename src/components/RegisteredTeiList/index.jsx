...
const RegisteredTeiList = ({
        ...
        let columns = trackedEntityAttributes
            ...
            .map((tea) => {
                const teaObject = {
                    ...
                    render: (value) => (
                        <TableColumn metadata={tea} value={value} />
                    ),
                };
                return teaObject;
            });
    ...
    const createDataSource = () => {
        ...
        const data = teis.trackedEntityInstances.map((tei, index) => {
            const rowObject = {
                key: index,
            };

            rowObject.teiId = tei.trackedEntityInstance;
    ...
    const createDataSourceQuery = () => {
        ...
        const data = teis.rows.map((row, index) => {
            ...
            const teiIdIndex = teis.headers.findIndex(
                (h) => h.name === 'instance'
            );
