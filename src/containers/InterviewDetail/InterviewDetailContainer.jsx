...
const InterviewDetailContainer = () => {
  ...
  useEffect(() => {
    ...
    const disabledInterviews = interviewResultEvents.reduce((acc, curr) => {
      ...
      if (
        (curr.dataValues[HOUSEHOLD_APPROVAL_STATUS] === "Needs_updates" ||
          !curr.dataValues[HOUSEHOLD_APPROVAL_STATUS]) && 
        (curr.dataValues[HOUSEHOLD_INTERVIEW_RESULT_COMPLETE_DE_ID] === "Completed" || 
