...
import { changeTab, editingAttributes, submitAttributes } from "../../redux/actions/data";
...
const ProfileFormContainer = () => {
  ...
  const isEditingAttributes = useSelector((state) => state.data.tei.isEditingAttributes);
