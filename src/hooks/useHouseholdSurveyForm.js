...
const useHouseholdSurveyForm = (values, selectedOuPath) => {
    ...
    function loadServeyFields(event = []) {
        console.log('event :>> ', values, event[0]);
        ...
        if (event.length) {
            ...
            if (uuid == 'NPb0hOBn6g9' && value == 'Empty') {
                ...
                console.log('NPb0hOBn6g9: value !=Empty')
        ...
        console.log('tableRenderData :>> ', values, tableRenderData);

       
        setSurveyList(tableRenderData)
    }
